...
(function(){
  ...
  // Autoplay must start muted; silently unmute on the first user interaction
  // (the native volume control is also always available).
  function unmute(){ video.muted=false; video.volume=1; video.play().catch(function(){}); }
